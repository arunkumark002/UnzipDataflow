...
public  class DecompressDoFn extends DoFn<FileIO.ReadableFile, String> {

    private final String destinationLocation;

    public DecompressDoFn(String destinationLocation) {
    ...
    public void processElement(@Element FileIO.ReadableFile file,ProcessContext context) throws IOException {
        ...
        try{
            ...
            while(ze!=null){
                ...
                //while (remaining>0 && (len=zis.read(buffer, 0, Math.max(1024, remaining))) != -1){
