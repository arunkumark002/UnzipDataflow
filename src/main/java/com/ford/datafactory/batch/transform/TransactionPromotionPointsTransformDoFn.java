...
public class TransactionPromotionPointsTransformDoFn extends DoFn<FileIO.ReadableFile , String> {
...
// We can now access the file and its metadata.
        ...
        if (fileName.contains("TransactionPromotionPoints") &&
            ...
            try (InputStream stream = Channels.newInputStream(file.open())) {
                ...
                while ((line = streamReader.readLine()) != null) {
                    ...
                    String record = new TransactionPromotionPointsDataDecoder().decode(headerTimestamp, line);
                    if (null != record) {
