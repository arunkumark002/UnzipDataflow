...
public class TransactionRuleTransformDoFn extends DoFn<FileIO.ReadableFile , String> {
...
// We can now access the file and its metadata.
        ...
        if(fileName.contains("TransactionRule") &&
            ...
            try (InputStream stream = Channels.newInputStream(file.open())) {
                ...
                while ((line = streamReader.readLine()) != null) {
                    ...
                    String record = new TransactionRuleDecoder().decodeWithCntry(headerTimestamp, line, countryCode);
                    if (null != record) {
