...
import com.ford.datafactory.batch.decoder.VinDataDecoder;
...
public class VinDataTransformDoFn extends DoFn<FileIO.ReadableFile , String> {
        ...
        if(fileName.contains("VIN") &&
            ...
            try (InputStream stream = Channels.newInputStream(file.open())) {
                ...
                while ((line = streamReader.readLine()) != null) {
                    ...
                    String record = new VinDataDecoder().decode(headerTimestamp, line);
                    if (null != record) {
